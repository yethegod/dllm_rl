...
from models.mmada import MMadaConfig, MMadaModelLM
...
def main():
    ...
    for x in dataset_load:
        ...
        image_tok_list.append(x.get("image_token_ids"))
    if config.dataset.data_type == "mmu":
        ...
        input_ids, labels, p_mask_lm, rewards, start_pos, drop_num = prepare_inputs_and_labels_for_mmu(
            prompt_list, response_list, step_map_list, reward_list, image_tok_list
        )
    else:
        input_ids, labels, p_mask_lm, rewards, start_pos, drop_num = prepare_inputs_and_labels_for_text(
            prompt_list, response_list, step_map_list, reward_list
        )
